package com.spring.qa.autoGb.lesson6;

import com.spring.qa.autoGb.lesson4.entity.AddressEntity;
...
public class UserRepositoryTest {
    ...
    void getUserByFirstNameAndSecondNameTest() {
        ...
        userEntity.setSecondName("Glagolev");
        testEntityManager.persistAndFlush(userEntity);
        ...
        SoftAssertions.assertSoftly(s -> {
            s.assertThat(entity.get().getFirstName()).isEqualTo("Vlad");
            s.assertThat(entity.get().getSecondName()).isEqualTo("Glagolev");
            s.assertThat(entity.get().getAge()).isEqualTo(28);
        });
    }
}
