package com.spring.qa.autoGb.lesson5.mock;

import com.spring.qa.autoGb.lesson2.example.dto.User;
import com.spring.qa.autoGb.lesson5.restassured.mock.AuditService;
import com.spring.qa.autoGb.lesson5.restassured.mock.ResponseResult;
import com.spring.qa.autoGb.lesson5.restassured.mock.RestService;
...
public class RestServiceMockTest {
    ...
    void mockAuditTest() throws InterruptedException {
        ...
        ResponseResult responseResult = restService.sendRequest(new User());
